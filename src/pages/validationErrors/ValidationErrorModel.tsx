    ...
    if (currentDataSource?.entityId?.attributes && openModal) {
      ...
      const fetchOptions = async () => {
        for (const currentAttribute of attributes) {
          if (
            (currentAttribute.type === "option" || currentAttribute.type === "multioption") &&
            ...
            try {
              ...
              if (optionAttribute && Array.isArray(optionAttribute.attributeValue)) {
                optionsMap[currentAttribute.optionAttributeId] = optionAttribute.attributeValue.map(
                  (value: string) => ({
                    id: value,
                    label: value,
                  })
        ...
        return (
          <Autocomplete
            ...
            renderOption={(props, option) => {
              ...
              return (
                <li key={typeof option === "string" ? option : option.id} {...otherProps}>
