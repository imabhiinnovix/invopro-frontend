...
//     }
//   };
//   // {{reportivixUrl}}/common/dataImportError/data?dataSourceVersionId=690355e9c0b6e540cbdfd01a&dataSourceId=6901aff0eeec00858ff1f529&rowNumber=4
// // ERROR_ROW_DATA
//   // Initialize form data when modal opens or row data changes
//   React.useEffect(() => {
//     console.log("rowData", rowData, openModal, effectiveDataSource);
...
//   //       // Handle different input formats for fieldValue
//   //       if (Array.isArray(fieldValue)) {
//   //         selectedValues = fieldValue;
//   //       } else if (fieldValue && typeof fieldValue === 'string') {
//   //         selectedValues = fieldValue.split(delimiter).map((val: string) => val.trim());
//   //       }
...
//     // Check if this is the target attribute for error code 1003 only
...
//   // Initialize form data when modal opens or row data changes
//   React.useEffect(() => {
//     console.log("rowData", rowData, "rowDetailData", rowDetailData, openModal, effectiveDataSource);
//     if (rowData && openModal && effectiveDataSource?.entityId?.attributes) {
//       const initialFormData: Record<string, any> = {};
      
//       // For error code 1002, get rowData from rowDetailData if available
//       let sourceData = rowData;
//       if (errorCode === "1002" && rowDetailData && rowDetailData.length > 0) {
//         sourceData = rowDetailData[0].rowData || rowData;
...
//     const isTargetAttribute = isTargetAttributeFor1003 || isTargetAttributeFor1002;
