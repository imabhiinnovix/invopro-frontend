...
export default function NoErrorLogs({
  id,
  dataSourceId,
  paginationModel,
  setPaginationModel,
  ...
  const rows =
    noErrorList?.data?.data?.map((row: any) => ({
      ...row,
      id: row._id,
    ...
    <Card>
      <CardContent>
        ...
        <NoErrorsDataTable
          ...
          rowCount={noErrorList?.data?.totalCount || 0}
          validationErrorList={noErrorList}
