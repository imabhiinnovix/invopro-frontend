                ...
                filter.columns.map((column) => (
                  ...
                  >
                    <Box display="flex" alignItems="center" gap={2} sx={{ mb: STYLE_GUIDE.SPACING.s1 }}>
                      <Typography sx={{ minWidth: 120, ...getBodySx(), fontWeight: 'bold' }}>Report Header:</Typography>
                              ...
                              <TextField
                                ...
                                sx={{
                                  '& .MuiOutlinedInput-root': {
                                    ...
                                    '& fieldset': {
                                      borderColor:
                                        theme.dashboardTheme?.colors?.inputBorder || STYLE_GUIDE.COLORS.darkBackground,
                                    },
                                    '&:hover fieldset': {
                                      borderColor:
                                        theme.dashboardTheme?.colors?.borderHover || STYLE_GUIDE.COLORS.darkBorderHover,
                                    },
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                          {column.attributeValues.length > 0 ? (
                            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                              {column.attributeValues.map((value, valueIndex) => (
                                <Chip key={valueIndex} label={value} size="small" variant="outlined" />
                              ))}
                            </Box>
                          ) : (
                            <Typography
