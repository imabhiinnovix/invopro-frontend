  ...
  useEffect(() => {
    if (theme) {
      setThemeState({
        ...
        showLegendOverlay:
          theme.showLegendOverlay || themeState.showLegendOverlay,
      });
    } else if (open) {
            ...
            <TextField
              ...
              sx={{
                "& .MuiOutlinedInput-root": {
                  ...
                  fontSize: "14px",
                  backgroundColor:
                    unifiedTheme.dashboardTheme?.colors?.background?.paper ||
                    "#ffffff",
                  "& fieldset": {
                    borderColor:
                      unifiedTheme.dashboardTheme?.colors?.inputBorder ||
                      STYLE_GUIDE.COLORS.darkBackground,
                  },
                  "&:hover fieldset": {
                    borderColor:
                      unifiedTheme.dashboardTheme?.colors?.borderHover ||
                      STYLE_GUIDE.COLORS.darkBorderHover,
                  },
                  "&.Mui-focused fieldset": {
                    borderColor:
                      unifiedTheme.dashboardTheme?.components?.input
                        ?.focusBorderColor ||
                ...
                "& .MuiInputLabel-root": {
                  color:
                    unifiedTheme.dashboardTheme?.colors?.text?.secondary ||
                    STYLE_GUIDE.COLORS.darkBorderFocus,
                },
                "& .MuiInputLabel-root.Mui-focused": {
                  color:
                    unifiedTheme.dashboardTheme?.components?.input
                      ?.focusBorderColor || STYLE_GUIDE.COLORS.darkDarker,
                },
                "& .MuiInputBase-input": {
                  ...
                  >
                    <Button
                      ...
                      sx={{
                        ...
                        color:
                          color === "#000000" ? "white" : "rgba(0, 0, 0, 0.6)",
                        width: "100%",
                        minHeight: "36px",
                        borderColor: "rgba(0, 0, 0, 0.12)",
                        "&:hover": {
                      ...
                      <Portal>
                        ...
                        <Box
                          sx={{
                            ...
                            zIndex: 9999,
                            ...(() => {
                              const buttonEl = buttonRefs.get(`color-${index}`);
                              if (!buttonEl) return {};
                              const rect = buttonEl.getBoundingClientRect();
                              const pickerHeight = 300;
                              const viewportHeight = window.innerHeight;
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              ...
              <Button
                ...
                onClick={() =>
                  setThemeState({
                    ...themeState,
                    backgroundColor: [...themeState.backgroundColor, "#000000"],
                  })
                }
                sx={{ mt: 1 }}
              >
