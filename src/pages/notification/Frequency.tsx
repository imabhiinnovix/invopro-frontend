...
//   useEffect(() => {
//     // Only run when we have reminder data and we're in edit mode
//     if (!reminderData?.data || !editMode) {
//       return;
//     }

//     console.log("Loading edit data:", reminderData.data); // Debug log
...
//     // Handle weekly frequency - FIXED VERSION
//     if (data.frequency === "weekly" && data.daysOfWeek?.length > 0) {
//       const dayNames = [
//         "Sunday",
//         "Monday",
...
//     } else {
//       setWeeklyDays([]); // Clear if not weekly
//     }
...
//   }, [reminderData?.data, editMode, fieldOptions]); // Only these dependencies
//   // Handlers
