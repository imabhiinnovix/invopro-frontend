...
export const UsersRoles: React.FC<PageProps> = ({ onNavigate }) => {
    ...
    <div style={{ padding: 24 }}>
      <SectionHeader
        ...
        actions={
          <Button
            variant="primary"
            onClick={() => navigate("/add-user")}   // ✅ navigation added
          >
        ...
        <div>
          <div style={{ marginBottom:12 }}>
            <Button
              variant="primary"
              size="sm"
              onClick={() => navigate("/add-role")}   // ✅ navigation added
            >
              <svg width="12" height="12" viewBox="0 0 24 24" fill="white">
