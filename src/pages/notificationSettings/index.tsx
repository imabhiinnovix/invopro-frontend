...
import { Box, Card, CardContent, Typography, TextField, Button, InputAdornment, Modal, Dialog, DialogTitle, DialogContent, DialogActions } from '@mui/material';
      ...
      >
        ...
        >
          <Typography variant="h6" sx={{ mb: 2, color: STYLE_GUIDE?.COLORS?.primaryDark || '#3f51b5' }}>
            {modalMode === 'add' ? 'Add Notification' : 
             modalMode === 'edit' ? 'Edit Notification' : 
             modalMode === 'view' ? 'View Notification' : 'Filter Notifications'}
          </Typography>
          <Box
            sx={{
              display: 'grid',
