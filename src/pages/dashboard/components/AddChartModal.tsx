...
//   console.log("formData.dimensions", formData);
//   console.log("isTrend", selectedDataSource);
...
//   const getAttributeOptionse = (): DataSourceAttribute[] => {
...
//                       //   <MenuItem key={attr.mappingName} value={attr.label} disabled={attr.label === formData.groupBy}>
//                       //     {attr.label}
//                       //   </MenuItem>
//                       // ))
//                       getAttributeOptions().map((attr) => {
//                         console.log("here",attr); // Yahan pe console log karenge

//                         return (
//                           <MenuItem
//                             key={attr.mappingName}
//                             value={attr.label}
//                             // disabled={attr.label === formData.groupBy}
//                           >
//                             {attr.label}
//                           </MenuItem>
//                         );
