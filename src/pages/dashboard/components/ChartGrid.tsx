...
//   PolarArea,
//   Chart,
// } from "react-chartjs-2"; // Added Chart import
// import {
//   ChartDataItem,
//   ChartGridProps,
//   ChartResponse,
...
//   // Separate number charts and other charts
...
//         // Create datasets - first dataset will be line, others will be stacked bars
...
//           // First dataset is line, others are stacked bars
//           if (index === 0) {
//             return {
//               label: group,
//               data: groupData,
...
//         // Create datasets - first dataset will be line, others will be bars
//         const datasets = uniqueGroups.map((group, index) => {
//           let totalDataBasedOnGroup = 0;
//           const groupData = barLabels.map((name) => {
//             const dataPoint = chartData.find(
...
//           // First dataset is line, others are bars (not stacked)
//           if (index === 0) {
//             return {
//               label: group,
//               data: groupData,
...
//         }}
//       >
//         {/* Number Charts Section - 3 per row */}
...
export const ChartGrid: React.FC<ChartGridProps> = ({
  ...
  // For grouped horizontal bar charts (keep existing logic)
  const groupByField = groupBy[0];
  const uniqueGroups = Array.from(
    new Set(chartData.map((item) => item[groupByField] as string))
  );
  ...
  return {
    ...
    plugins: {
      ...baseOptions.plugins,
      legend: {
        // display: groupBy && groupBy.length > 0,
