...
const NAV_ITEMS: Array<NavItem | { isSep?: true; group: string; id: string, label?: string, icon?: JSX.Element}> = [
  ...
  { id:"data-export-jobs",        label:"Data Export Jobs",                icon:<path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM7 7h10v2H7zm0 4h10v2H7zm0 4h7v2H7z"/>,                                         group:"" },
