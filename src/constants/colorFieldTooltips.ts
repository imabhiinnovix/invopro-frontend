export const COLOR_FIELD_TOOLTIPS: { [key: string]: string } = {
  ...
  'Input Focus Border Color': 'Border color for input fields when focused/selected',
  'Input Focus Border Fallback': 'Fallback border color for input focus when primary focus color is not available',
  'Dropdown Background': 'Background color for dropdown menus and select components',
  'Dropdown Border Color': 'Border color for dropdown menus and select components',
